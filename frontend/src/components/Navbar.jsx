...
//  { label:"Contact", path:"/contact" },
 ...
 return (
 <header className="w-full fixed top-0 left-0 z-30 bg-white/90 border-b border-gray-200 shadow-sm backdrop-blur-md transition-colors duration-300">
 ...
 animate={{ opacity: 1, y: 0 }}
 exit={{ opacity: 0, y: -25 }}
 className="md:hidden bg-white border-t border-gray-200 shadow-md text-gray-900 transition-colors duration-300"
 >
