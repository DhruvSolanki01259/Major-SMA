...
import { Lock, Mail, User, X, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-10">
      ...
      >
        ...
        >
          ...
          <div className="w-full md:w-1/2 p-8 md:p-10 flex items-center justify-center">
            <div className="w-full max-w-lg">
              ...
              <form className="space-y-4" onSubmit={handleSignup}>
                ...
                <button
                  type="submit"
                  className="w-full py-3 rounded-lg font-semibold text-white bg-[#01497C] hover:bg-[#014F86] transition flex items-center justify-center disabled:opacity-70"
                  disabled={isLoading}
                >
          ...
          {/* RIGHT */}
          <div className="hidden md:flex md:w-1/2 border-l p-10 items-center justify-center flex-col bg-[#F1F5F9] border-[#E2E8F0]">
